...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${base}/los-angeles-website-audit`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.8 },
    { url: `${base}/manchester-website-audit`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.8 },
    { url: `${base}/chicago-website-audit`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.8 },
    { url: `${base}/shopify-website-audit`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.8 },
