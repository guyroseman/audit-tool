...
export const metadata: Metadata = {
  title: "Free Website Audit London — Instant Performance & SEO Report",
  description: "Free website audit for London businesses. See your performance score, ad spend waste, ADA risk, and SEO gaps in 60 seconds. Used by 1,000+ UK businesses.",
  keywords: "website audit london, free website audit london, london seo audit, website performance audit london, london website checker",
  alternates: { canonical: `${BASE}/london-website-audit` },
  openGraph: {
    type: "website",
    title: "Free Website Audit for London Businesses",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Free Website Audit London",
  description: "Free 5-pillar website audit for London businesses covering performance, SEO, accessibility, security, and AI visibility.",
  provider: { "@type": "Organization", name: "Nexus", url: BASE },
  areaServed: { "@type": "City", name: "London" },
  offers: { "@type": "Offer", price: "0", priceCurrency: "GBP" },
};

export default function LondonAuditPage() {
  return (
    <main style={{ minHeight: "100vh", background: "var(--bg)" }}>
      ...
      <section style={{ maxWidth: 860, margin: "0 auto", padding: "clamp(64px,10vw,112px) 24px clamp(48px,6vw,80px)", textAlign: "center" }}>
        ...
        <h1 style={{ fontFamily: "var(--font-display)", fontSize: "clamp(32px,6vw,68px)", color: "var(--text)", letterSpacing: "0.03em", lineHeight: 1.1, marginBottom: 22 }}>
          Free Website Audit<br />for London Businesses
        </h1>
        <p style={{ fontFamily: "var(--font-body)", fontSize: "clamp(15px,2vw,18px)", color: "var(--text2)", lineHeight: 1.7, maxWidth: 620, margin: "0 auto 40px" }}>
          See your performance score, how much you're overpaying on Google Ads, your ADA risk level,
      ...
      <section style={{ maxWidth: 860, margin: "0 auto", padding: "0 24px 80px" }}>
        <h2 style={{ fontFamily: "var(--font-display)", fontSize: "clamp(22px,3.5vw,34px)", color: "var(--text)", letterSpacing: "0.04em", marginBottom: 32, textAlign: "center" }}>
          WHY LONDON BUSINESSES USE THIS
        </h2>
